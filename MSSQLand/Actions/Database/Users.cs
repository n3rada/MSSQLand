...
namespace MSSQLand.Actions.Database
{
    ...
    internal class Users : BaseAction
    {
        public override object Execute(DatabaseContext databaseContext)
        {
            ...
            Logger.InfoNested("Database users in current context");
